<?php
    /*
    Plugin Name: CTL Arcade - American Football Challenge
    Plugin URI: http://www.codethislab.com/
    Description: American Football Challenge for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeAmericanFootballChallenge{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-american-football-challenge";
        private $_szPluginName              = "American Football Challenge";
        private $_szAspectRatio             = "16:10";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "quarterback, football, American Football, goal, american sport, kick, penalty kick, penalty game, sport game, super bowl, freekick, skill game, goal game, 3d, 3d game";
    ...
    $g_oCTLArcadeAmericanFootballChallenge =  new CTLArcadeAmericanFootballChallenge();
