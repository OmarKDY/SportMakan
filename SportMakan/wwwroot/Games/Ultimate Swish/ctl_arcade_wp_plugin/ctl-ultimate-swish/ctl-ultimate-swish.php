<?php
    /*
    Plugin Name: CTL Arcade - Ultimate Swish
    Plugin URI: http://www.codethislab.com/
    Description: Ultimate Swish for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeUltimateSwish{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-ultimate-swish";
        private $_szPluginName              = "Ultimate Swish";
        private $_szAspectRatio             = "4:3";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "3 points, basket, basketball, physic, physics, shootout, shot, sport, sport game, swish, three points, shoot-out, skill game, tap game, one button game";
    ...
    $g_oCTLArcadeUltimateSwish =  new CTLArcadeUltimateSwish();
