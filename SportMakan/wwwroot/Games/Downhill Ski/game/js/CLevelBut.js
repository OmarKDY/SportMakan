function CLevelBut(iXPos, iYPos, szText,szScore,oSprite, bActive,oParentContainer) {
    ...
    this._init = function (iXPos, iYPos, szText,szScore,oSprite, bActive) {
        ...
        var oSpriteCup = s_oSpriteLibrary.getSprite("icon_score");
        var oCup = createBitmap(oSpriteCup);
        oCup.x = iXPos-40;
        oCup.y = iYPos+22;
        _oContainer.addChild(oCup);
        
        if(szScore === null){
            szScore = 0;
        }
        
        _oScoreText = new createjs.Text(szScore, "20px " + FONT_GAME, "#fff");
        _oScoreText.x = iXPos+40;
        _oScoreText.y = iYPos + 37;
