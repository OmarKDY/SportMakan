function CNextLevelPanel(){
    ...
    this._init = function(){
        ...
        _oButRestart = new CGfxButton(oSpriteBg.width/2,oSpriteBg.height/2+110,s_oSpriteLibrary.getSprite("but_restart"),_oContainerPanel);
        _oButRestart.addEventListener(ON_MOUSE_UP,this._onRestart,this);
        
        _oButNext = new CGfxButton(oSpriteBg.width/2 + 200,oSpriteBg.height/2+110,s_oSpriteLibrary.getSprite("but_next"),_oContainerPanel);
