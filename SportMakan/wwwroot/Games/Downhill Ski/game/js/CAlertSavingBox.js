function CAlertSavingBox(szText,oParentContainer){
    ...
    this._init = function (szText) {
        ...
        _oMsg = new CTLText(_oContainer, 
                    CANVAS_WIDTH / 2 -oSpriteBg.width/2, CANVAS_HEIGHT/2-90, oSpriteBg.width, 200, 
        ...
        _oButOk = new CSideGfxButton(false,1024 , 250, s_oSpriteLibrary.getSprite('but_exit'), _oContainer);
