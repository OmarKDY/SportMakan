<?php
    /*
    Plugin Name: CTL Arcade - Real Tennis
    Plugin URI: http://www.codethislab.com/
    Description: Real Tennis for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeRealTennis{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-real-tennis";
        private $_szPluginName              = "Real Tennis";
        private $_szAspectRatio             = "15:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "tennis, wimbledon, court, sport game, skill game, sports, tournament, smash, backhand, tennis game, forehand, service, wordpress, leaderboard";
    ...
    $g_oCTLArcadeRealTennis =  new CTLArcadeRealTennis();
