function CInterface(iLevel,_iTotScore,oParentContainer) {
    ...
    this.showFinalPanel = function(szResult,iTotScore,iLevelScore,bGameOver,bLastLevel,iCurLevel){
        _oFinalPanel.show(szResult,iTotScore,iLevelScore,bGameOver,bLastLevel,iCurLevel);
    };
