        ...
        for(var k=0; k<2; k++){
            for(var n=0; n<SPRITE_NAME_GOALKEEPER.length; n++){
                for(var i=0;i<NUM_SPRITE_GOALKEEPER[n];i++){
                    s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[n]+"_"+k+"_"+i, "./sprites/striker/goalkeeper/gk_"+k+"/"+SPRITE_NAME_GOALKEEPER[n]+"/"+SPRITE_NAME_GOALKEEPER[n]+"_"+k+"_"+i+".png");
                }
            }
        };
