<?php
    /*
    Plugin Name: CTL Arcade - Penalty Challenge
    Plugin URI: http://www.codethislab.com/
    Description: Penalty Challenge for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadePenaltyChallenge{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-penalty-challenge";
        private $_szPluginName              = "Penalty Challenge";
        private $_szAspectRatio             = "18:9";
    ...
    $g_oCTLArcadePenaltyChallenge =  new CTLArcadePenaltyChallenge();
