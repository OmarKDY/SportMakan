<?php
    /*
    Plugin Name: CTL Arcade - Rugby Kicks
    Plugin URI: http://www.codethislab.com/
    Description: Rugby Kicks for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeRugbyKicks{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-rugby-kicks";
        private $_szPluginName              = "Rugby Kicks";
        private $_szAspectRatio             = "3:5";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "rugby games, football, rugby, 3D, sport game, sports game, sport games,  freekick, skill game, penalty, penalties, goal, tackle, all blacks , kick";
    ...
    $g_oCTLArcadeRugbyKicks =  new CTLArcadeRugbyKicks();
