...
function createOrthoGraphicCamera(){
    ...
    oCamera.rotation.x  = 88.1 * (Math.PI / 180);
    oCamera.rotation.y = 0.0 * (Math.PI / 180);
...
function saveItem(szItem,oValue){
    try{
        window.localStorage.setItem(szItem, oValue);
    }catch(e){
        console.log(e);
    }
...
function getItem(szItem){
    try{
        return window.localStorage.getItem(szItem);
    }catch(e){
        console.log(e);
    }
}
