function CWinPanel(oSpriteBg) {
    ...
    this._init = function (oSpriteBg) {
        ...
        _oBestScoreTextStroke = new CTLText(_oGroup, 
                    CANVAS_WIDTH / 2 -oSpriteBg.width/2+150, CANVAS_HEIGHT_HALF+40, oSpriteBg.width-300, 70, 
                    60, "center", TEXT_COLOR_STROKE, FONT_GAME, 1.1,
                    0, 0,
                    "",
                    true, true, false,
        ...
        _oButRestart = new CGfxButton(CANVAS_WIDTH * 0.5 + 260, CANVAS_HEIGHT * 0.5 + 130, oSpriteButRestart, _oGroup);
        ...
        _oButMenu = new CGfxButton(CANVAS_WIDTH * 0.5 - 250, CANVAS_HEIGHT * 0.5 + 130, oSpriteButHome, _oGroup);
