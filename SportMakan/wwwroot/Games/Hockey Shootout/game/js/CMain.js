function CMain(oData) {
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("logo_field", "./sprites/logo_field.png");
        ...
        for (var i = 0; i < NUM_SPRITE_GOALKEEPER[IDLE]; i++) {
            s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[IDLE] + i, "./sprites/goalkeeper_idle/gk_" + i + ".png");
        }

        for (var i = 0; i < NUM_SPRITE_GOALKEEPER[RIGHT]; i++) {
            s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[RIGHT] + i, "./sprites/goalkeeper_save_right/gk_" + i + ".png");
        }

        for (var i = 0; i < NUM_SPRITE_GOALKEEPER[LEFT]; i++) {
            s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[LEFT] + i, "./sprites/goalkeeper_save_left/gk_" + i + ".png");
        }

        for (var i = 0; i < NUM_SPRITE_GOALKEEPER[CENTER_DOWN]; i++) {
            s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[CENTER_DOWN] + i, "./sprites/goalkeeper_save_center/gk_" + i + ".png");
        }

        for (var i = 0; i < NUM_SPRITE_GOALKEEPER[RIGHT_DOWN]; i++) {
            s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[RIGHT_DOWN] + i, "./sprites/goalkeeper_save_down_right/gk_" + i + ".png");
        }
