<?php
    /*
    Plugin Name: CTL Arcade - Hockey Shootout
    Plugin URI: http://www.codethislab.com/
    Description: Hockey Shootout for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeHockeyShootout{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-hockey-shootout";
        private $_szPluginName              = "Hockey Shootout";
        private $_szAspectRatio             = "17:8";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "sport game, action game, winter game, skill game, penalty kicks, ice hockey, winter olympics game, goal, goalkeeper, penalty game, kick, penalties, defend, winter game, arcade game";
    ...
    $g_oCTLArcadeHockeyShootout =  new CTLArcadeHockeyShootout();
