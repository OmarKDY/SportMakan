function CLevelMenu(){
    ...
    this._init = function(){
        ...
        _oTextLevel = new CTLText(_oContainerPanel, 
                    _oSpriteBg.width/2- 350,  50, 700, 70, 
    ...
    this._createNewLevelPage = function(iStartLevel,iEndLevel){
        ...
        for(var i=iStartLevel;i<iEndLevel;i++){
            ...
            if((i+1)>s_iLastLevel){
                ...
                bActive = true;
                szBest = s_oMain.getTotBestTimePerLevel(i+1);                
            }
            
            var oBut = new CLevelBut(_aPointsX[iCont] + oSprite.width/4, iY + oSprite.height/2, i+1,szBest,oSprite,bActive ,oContainerLevelBut);
