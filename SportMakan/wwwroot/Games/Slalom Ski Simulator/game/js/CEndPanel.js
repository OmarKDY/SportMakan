function CEndPanel(){
    ...
    this._init = function(){
        ...
        _oTitleText = new CTLText(_oContainerPanel, 
                    oSpriteBg.width/2-250,  oSpriteBg.height/2-140, 500, 60, 
                    60, "center", "#ff7800", FONT_GAME, 1,
                    0, 0,
                    " ",
                    true, true, false,
                    false );
        ...
        _oTotScoreText = new CTLText(_oContainerPanel, 
                    oSpriteBg.width/2-250,  oSpriteBg.height/2-40, 500, 40, 
        ...
        _oButHome = new CGfxButton(oSpriteBg.width/2 - 200,oSpriteBg.height/2 + 110,s_oSpriteLibrary.getSprite("but_home"),_oContainerPanel);
        _oButHome.addEventListener(ON_MOUSE_UP,this._onHome,this);
        
        _oButRestart = new CGfxButton(oSpriteBg.width/2 + 200,oSpriteBg.height/2+110,s_oSpriteLibrary.getSprite("but_restart"),_oContainerPanel);
    ...
    this.show = function(iTotScore,szTitle){
        ...
        if(szTitle === TEXT_CONGRATS){
            oSound = playMusicSound("level_win",1,false);
        }else{
            oSound = playMusicSound("game_over",1,false);
        }
