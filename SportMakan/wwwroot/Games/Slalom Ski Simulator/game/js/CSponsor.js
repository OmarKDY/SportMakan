function CSponsor(iX,iY,bLeft,oParentContainer){
    ...
    this._init = function(iX,iY){
        ...
        var oSpriteSponsor = s_oSpriteLibrary.getSprite("sponsor_"+(bLeft?0:1));
    ...
    this.startAnim = function(){
        ...
        new createjs.Tween.get(_oContainer).to({x:_iArrivalX,y:_iArrivalY}, TIME_GATE_RUN, createjs.Ease.quintIn).call(function(){
        ...
        new createjs.Tween.get(_oContainer).to({scaleX:1,scaleY:1},TIME_GATE_RUN,createjs.Ease.quartIn);
    };
