<?php
    /*
    Plugin Name: CTL Arcade - Slalom Ski Simulator
    Plugin URI: http://www.codethislab.com/
    Description: Slalom Ski Simulator for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSlalomSkiSimulator{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-slalom-ski-simulator";
        private $_szPluginName              = "Slalom Ski Simulator";
        private $_szAspectRatio             = "19:10";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "olympic, ski, skier, sport, sport game, snow, seasonal, 3D, 3D game, classic, olympic game, run, running, rush, simulation";
    ...
    $g_oCTLArcadeSlalomSkiSimulator =  new CTLArcadeSlalomSkiSimulator();
