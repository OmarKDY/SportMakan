<?php
    /*
    Plugin Name: CTL Arcade - Goalkeeper Challenge
    Plugin URI: http://www.codethislab.com/
    Description: Goalkeeper Challenge for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeGoalkeeperChallenge{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-goalkeeper-challenge";
        private $_szPluginName              = "Goalkeeper Challenge";
        private $_szAspectRatio             = "16:10";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "defend, football, goalkeeper, goal, soccer, kick, penalty kick, penalty game, sport game, world cup, freekick, skill game, goal game, soccer game, european football championship";
    ...
    $g_oCTLArcadeGoalkeeperChallenge =  new CTLArcadeGoalkeeperChallenge();
